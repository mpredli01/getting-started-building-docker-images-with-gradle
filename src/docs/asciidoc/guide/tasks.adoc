...
This is a list of defined task names and their dependencies that you will use for the example application:
...
You will be adding all of these to your `build.gradle` file. We will discuss each of these and their corresponding classes.

=== Create Dockerfile

You will need a template Docker file for this application. In the root directory of your project, create a file named `Dockerfile.tmpl` with the following content:
